...
<div class="now-card">
  <div class="now-card-header">
    <h3>Talk. Art. Therapy.</h3>
  </div>
  <p>Individual counselling sessions combining conversation, art, and contemplation.</p>
  <a class="now-card-cta" href="{{ site.baseurl }}/booking">Book a session</a>
</div>

<div class="now-card">
  <div class="now-card-header">
    <h3>Social Meditation</h3>
  </div>
  <p>Free online group meditation, Monday–Thursday 6:30am AEST.</p>
  <a class="now-card-cta" href="http://wepracticetogether.net/">Join next session</a>
</div>
